...
Personal use local audio player based on [just_audio](https://pub.dev/packages/just_audio).
Covers some basic operations:
Scan folders and list folders containing audio files (flac, wav, mp3, etc.)
List audio files
Audio player
