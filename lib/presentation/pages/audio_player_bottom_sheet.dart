...
import 'package:music_player/domain/entities/audio_position_entity.dart';
import 'package:music_player/presentation/widgets/album_cover.dart';
import 'package:music_player/presentation/widgets/control_buttons.dart';
import 'package:music_player/presentation/widgets/seek_bar.dart';
...
class _AudioPlayerState extends State<AudioPlayerBottomSheet> with WidgetsBindingObserver {
  ...
  Stream<AudioPositionEntity> get _positionDataStream =>
      Rx.combineLatest2<Duration, Duration?, AudioPositionEntity>(
          ...
          (position, duration) => AudioPositionEntity(position, duration ?? Duration.zero));
